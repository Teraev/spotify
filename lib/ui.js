...
export function createHeader(place) {
  ...
  leftImg.src = '../img/left_strelka.svg';
  leftImg.alt = '';
  leftButton.append(leftImg);

  const rightButton = document.createElement('button');
  const rightImg = document.createElement('img');
  rightImg.src = '../img/right_strelka.svg';
  rightImg.alt = '';
  rightButton.append(rightImg);

  leftDiv.append(leftButton, rightButton);
...
export function createFotter(place) {
  ...
  const footerBottomItem1 = document.createElement('li');
  const footerBottomLink1 = document.createElement('a');
  footerBottomLink1.href = '#';
  footerBottomLink1.textContent = 'Юридическая информация';
  footerBottomItem1.append(footerBottomLink1);

  const footerBottomItem2 = document.createElement('li');
  const footerBottomLink2 = document.createElement('a');
  footerBottomLink2.href = '#';
  footerBottomLink2.textContent = 'Центр безопасности и конфиденциальности';
  footerBottomItem2.append(footerBottomLink2);

  const footerBottomItem3 = document.createElement('li');
  const footerBottomLink3 = document.createElement('a');
  footerBottomLink3.href = '#';
  footerBottomLink3.textContent = 'Политика конфиденциальности';
  footerBottomItem3.append(footerBottomLink3);

  const footerBottomItem4 = document.createElement('li');
  const footerBottomLink4 = document.createElement('a');
  footerBottomLink4.href = '#';
  footerBottomLink4.textContent = 'Файлы cookie';
  footerBottomItem4.append(footerBottomLink4);

  const footerBottomItem5 = document.createElement('li');
  const footerBottomLink5 = document.createElement('a');
  footerBottomLink5.href = '#';
  footerBottomLink5.textContent = 'О рекламе';
  footerBottomItem5.append(footerBottomLink5);

  const footerBottomItem6 = document.createElement('li');
  const footerBottomLink6 = document.createElement('a');
  footerBottomLink6.href = '#';
  footerBottomLink6.textContent = 'Специальные возможности';
  footerBottomItem6.append(footerBottomLink6);

  footerBottomList.append(footerBottomItem1, footerBottomItem2, footerBottomItem3, footerBottomItem4, footerBottomItem5, footerBottomItem6);

  footerBottom.append(footerBottomList);

  const footerBottomText = document.createElement('p');
  footerBottomText.textContent = '© 2024 Spotify AB';
  footerBottom.append(footerBottomText);



  place.append(footerContainer, footerBottom)
}


let currentTrackNumber = 1;

export function createAlbumMus(item) {
  ...
  trackNumber.textContent = currentTrackNumber;  
  ...
  trackItem.append(trackNumber, trackPause , trackDetails , trackDetails , trackAlbum ,  trackDuration);
